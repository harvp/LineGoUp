...
outputString = "<h2> Stock Report for " + symbol + "</h2><center><table style= 'padding:10px; border:1px solid black; border-collapse:collapse;'>"
outputString += "<tr><th style= 'padding:10px; border:1px solid black;'>Date</th><th style= 'padding:10px; border:1px solid black;'>Trade Volume</th><th style= 'padding:10px; border:1px solid black;'>Opening Price</th><th style= 'padding:10px; border:1px solid black;'>Closing Price</th></tr>"
i = 0
for record in priceData:
    outputString += "<tr><td style= 'text-align:center; padding:10px; border:1px solid black;'>" + str(dates[i]) + "</td>"
    outputString += "<td style='text-align:center; padding:10px; border:1px solid black;'>" + str(record[1]) + "</td>"
    outputString += "<td style= 'text-align:center; padding:10px; border:1px solid black;'>" + str(record[2]) + "</td>"
    outputString += "<td style= 'text-align:center; padding:10px; border:1px solid black;'>" + str(record[3]) + "</td></tr>"
...
outputString += "<tr><td style= 'text-align:center; padding:10px; border:1px solid black;'>Average Volume Per Trading Day: </td><td style= 'border:1px solid black;'></td><td style= 'text-align:center; padding:10px; border:1px solid black;'>" + str(average_volume) + "</td></tr>"
average_pct = average_pct / tx_count
outputString += "<tr><td style= 'text-align:center; padding:10px; border:1px solid black;'>Average % Change in Price Per Day: </td><td style= 'border:1px solid black;'></td><td style= 'text-align:center; padding:10px; border:1px solid black;'>" + str(average_pct) + "</td></tr></center></table>"
print(outputString)