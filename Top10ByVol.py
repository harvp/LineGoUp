...
stats = [{}]
for i in range(1, 11):
    stats.append(reporter.getVol_by_rank(i))
...
outputString += "<tr><th style = 'padding:10px; border:1px solid black;'>Rank</th><th style = 'padding:10px; border:1px solid black;'>Name</th><th style = 'padding:10px; border:1px solid black;'>Ticker</th><th style = 'padding:10px; border:1px solid black;'>Volume VI</th><th style = 'padding:10px; border:1px solid black;'>Price VI</th><th style = 'padding:10px; border:1px solid black;'>Twitter Account</th></tr>"
i = 0
for record in stats:
    if i > 0:
