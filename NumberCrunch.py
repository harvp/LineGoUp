...
for record in priceData:
    ...
    outputString += "<td style = 'padding:5px; border:1px solid black;'>" + str(engagement_scores[i]) + "</td></tr>"
    i += 1
    if i == 7:
        break

outputString += "<tr><td style = 'padding:5px; border:1px solid black;'> </td></tr>"
outputString += "<tr><td style = 'padding:5px; border:1px solid black;'>Volatility Index by Trades: </td><td style= 'padding:5px; border:1px solid black;'></td><td style = 'border:1px solid black;'>" + str(volume_vi) + "</td></tr>"
outputString += "<tr><td style = 'padding:5px; border:1px solid black;'>Volatility Index by Price Change: </td><td style= 'padding:5px; border:1px solid black;'></td><td style = 'border:1px solid black;'>" + str(pct_vi) + "</td></tr></center></table>"
