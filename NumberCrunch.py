...
outputString += "<tr style = 'border:1px solid black; border-collapse:collapse;'><th>Date</th><th>Price Change</th><th>Trade Volume</th><th>Twitter Engagement Score</th></tr>"
i = 0
for record in priceData:
