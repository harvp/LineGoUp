...
outputString += "<tr><td style = 'padding=5px; border:1px solid black;'>Volatility Index by Trades: </td><td style = 'border:1px solid black;'></td><td style = 'border:1px solid black;'>" + str(volume_vi) + "</td></tr>"
outputString += "<tr><td style = 'padding=5px; border:1px solid black;'>Volatility Index by Price Change: </td><td style = 'border:1px solid black;'></td><td style = 'border:1px solid black;'>" + str(pct_vi) + "</td></tr></center></table>"
