...
for record in priceData:
    ...
    outputString += "<td style = 'border:1px solid black;'>" + str(record[1]) + "</td>"
    outputString += "<td style = 'border:1px solid black;'>" + str(record[2]) + "</td>"
    outputString += "<td style = 'border:1px solid black;'>" + str(engagement_scores[i]) + "</td></tr>"
    i += 1
    if i == 7:
        break
