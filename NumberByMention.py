...
query = "@" + user
response = client.search_recent_tweets(query=query, tweet_fields=['context_annotations', 'created_at', 'public_metrics'])
...
outputString = "<h2> Volatility By Mentions for " + company_name + "</h2><center><table style='padding:10px; border:1px solid black; border-collapse:collapse;'>"
...
for record in priceData:
    ...
    outputString += "<td style = 'text-align:center; padding:10px; border:1px solid black;'>" + str(engagement_scores[i]) + "</td></tr>"
    i += 1
    if i == 7:
        break

outputString += "<tr><td style = 'border:1px solid black;'> </td></tr>"
outputString += "<tr><td style = 'text-align:center; padding:10px; border:1px solid black;'>Volatility Index by Trades: </td><td style= 'text-align:center; padding:10px; border:1px solid black;'></td><td style = 'text-align:center; padding:10px; border:1px solid black;'>" + str(volume_vi) + "</td></tr>"
outputString += "<tr><td style = 'text-align:center; padding:10px; border:1px solid black;'>Volatility Index by Price Change: </td><td style= 'text-align:center; padding:10px; border:1px solid black;'></td><td style = 'text-align:center; padding:10px; border:1px solid black;'>" + str(pct_vi) + "</td></tr></center></table>"
